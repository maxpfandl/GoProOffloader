            ...
            foreach (string file in files)
            {
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(camera))
                        dest = System.IO.Path.Combine(_destination, creation.ToString("yyyy-MM-dd"), camera, creation.ToString("yyyyMMdd_HHmmss") + "_" + name);
                    else
                        dest = System.IO.Path.Combine(_destination, creation.ToString("yyyy-MM-dd"), creation.ToString("yyyyMMdd_HHmmss") + "_" + name);
